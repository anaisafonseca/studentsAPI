...
let StudentsRepositories = class StudentsRepositories extends typeorm_1.Repository {
};
StudentsRepositories = __decorate([
    typeorm_1.EntityRepository(Students_1.Student)
